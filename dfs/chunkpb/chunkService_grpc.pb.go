...
const (
	ChunkService_UploadChunk_FullMethodName   = "/chunk.ChunkService/UploadChunk"
	ChunkService_DownloadChunk_FullMethodName = "/chunk.ChunkService/DownloadChunk"
)
...
type ChunkServiceClient interface {
	UploadChunk(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ChunkData, UploadChunkStatus], error)
	DownloadChunk(ctx context.Context, in *DownloadChunkRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChunkData], error)
}
...
func (c *chunkServiceClient) UploadChunk(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[ChunkData, UploadChunkStatus], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ChunkService_ServiceDesc.Streams[0], ChunkService_UploadChunk_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ChunkData, UploadChunkStatus]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChunkService_UploadChunkClient = grpc.ClientStreamingClient[ChunkData, UploadChunkStatus]

func (c *chunkServiceClient) DownloadChunk(ctx context.Context, in *DownloadChunkRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChunkData], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ChunkService_ServiceDesc.Streams[1], ChunkService_DownloadChunk_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[DownloadChunkRequest, ChunkData]{ClientStream: stream}
...
type ChunkServiceServer interface {
	UploadChunk(grpc.ClientStreamingServer[ChunkData, UploadChunkStatus]) error
	DownloadChunk(*DownloadChunkRequest, grpc.ServerStreamingServer[ChunkData]) error
...
func (UnimplementedChunkServiceServer) UploadChunk(grpc.ClientStreamingServer[ChunkData, UploadChunkStatus]) error {
	return status.Errorf(codes.Unimplemented, "method UploadChunk not implemented")
}
func (UnimplementedChunkServiceServer) DownloadChunk(*DownloadChunkRequest, grpc.ServerStreamingServer[ChunkData]) error {
...
func _ChunkService_UploadChunk_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChunkServiceServer).UploadChunk(&grpc.GenericServerStream[ChunkData, UploadChunkStatus]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChunkService_UploadChunkServer = grpc.ClientStreamingServer[ChunkData, UploadChunkStatus]
...
func _ChunkService_DownloadChunk_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChunkServiceServer).DownloadChunk(m, &grpc.GenericServerStream[DownloadChunkRequest, ChunkData]{ServerStream: stream})
}
...
var ChunkService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/chunkService.proto",
}
